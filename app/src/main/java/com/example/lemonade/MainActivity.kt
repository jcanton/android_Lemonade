    ...
    private fun setViewElements() {
        ...
        when (lemonadeState) {
            SELECT -> {
                ...
                lemonImage!!.contentDescription = R.string.image_lemon_tree.toString()
            }
            SQUEEZE -> {
                textAction.setText(R.string.lemon_squeeze)
                lemonImage!!.setImageResource(R.drawable.lemon_squeeze)
                lemonImage!!.contentDescription = R.string.image_lemon.toString()
            }
            DRINK -> {
                textAction.setText(R.string.lemon_drink)
                lemonImage!!.setImageResource(R.drawable.lemon_drink)
                lemonImage!!.contentDescription = R.string.image_full_glass.toString()
            }
            RESTART -> {
                textAction.setText(R.string.lemon_empty_glass)
                lemonImage!!.setImageResource(R.drawable.lemon_restart)
                lemonImage!!.contentDescription = R.string.image_empty_glass.toString()
            }
        }
    }
